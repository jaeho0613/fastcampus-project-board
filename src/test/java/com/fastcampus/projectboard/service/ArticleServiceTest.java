...
class ArticleServiceTest {
    ...
    @DisplayName("게시글을 검색하면 게시글 리스트 반환한다.")
    @Test
    ...
    void givenArticlesInfo_whenSavingArticle_thenSavesArticle() {
        ...
        // When
        sut.saveArticle(ArticleDto.of(LocalDateTime.now(), "Jaeho", "title", "content", "#java"));
    ...
    @Test
    void givenArticleIdAndModifiedInfo_whenUpdatingArticle_thenSavesArticle() {
        given(articleRepository.save(ArgumentMatchers.any(Article.class))).willReturn(null);

        // When
        sut.updateArticle(1L, ArticleUpdateDto.of("title-update", "content", "#java"));
    ...
    @Test
    void givenArticleId_whenDeleteArticle_thenSavesArticle() {
        // Given
